  ...
  return (
    <SafeAreaView edges={["top"]} className="flex-1">
      ...
      <View className="flex-row items-center justify-between p-4 border-b border-border bg-background">
        ...
        <Text variant="h6" className="font-semibold">Menu Demo</Text>
      ...
      <ScrollView className="flex-1 p-4">
        <Text variant="h1" className="mb-8 text-center">Hamburger Menu Demo</Text>
          ...
          <Card className="mb-6">
            <CardHeader>
              ...
              <CardDescription>
                <Text variant="muted">The hamburger menu is positioned absolutely and won't interfere with your layout</Text>
              </CardDescription>
            </CardHeader>
          ...
          <Card className="mb-6">
            ...
            <CardContent className="gap-4">
              ...
              <Text variant="small" className="text-center mt-2 text-muted-foreground">
