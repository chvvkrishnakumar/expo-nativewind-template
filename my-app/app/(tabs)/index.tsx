  ...
  return (
    <SafeAreaView edges={["top"]} className="flex-1">
      <KeyboardAvoidingView className="flex-1">
        ...
        >
        <Text variant="h1" className="mb-4">UI Components Showcase</Text>
        ...
        <Card className="mb-8 border-primary/20">
          ...
          <CardContent>
            <Text variant="p" className="mb-3">
              Welcome! This showcase demonstrates all UI components available in your template.
            </Text>
            <View className="gap-2 mb-4">
              <Text variant="small" className="text-muted-foreground">
                💡 <Text className="font-semibold">Pro tip:</Text> Tap any code block to copy it!
              </Text>
              <Text variant="small" className="text-muted-foreground">
                🎨 <Text className="font-semibold">Dark mode:</Text> Toggle in your device settings
              </Text>
              <Text variant="small" className="text-muted-foreground">
                📱 <Text className="font-semibold">Platform:</Text> Components adapt to iOS/Android automatically
              </Text>
            </View>
            <Pressable 
...
export default function MyScreen() {
  return (
    <Button onPress={() => alert('Hello!')}>
      <Text>Get Started</Text>
        ...
        {/* Buttons Section */}
        <Text variant="h2" className="mb-4">Buttons</Text>
        <Card className="mb-3">
  ...
  <Text>Click me</Text>
            ...
            >
              <Text variant="code" className="text-xs">Tap to copy button code</Text>
            </Pressable>
          </CardContent>
        </Card>
        ...
        {/* Button Sizes */}
        <Text variant="h3" className="mb-4">Button Sizes</Text>
        <View className="flex-row flex-wrap gap-2 mb-8">
          <Button size="sm">
            <Text>Small</Text>
          </Button>
        ...
        {/* Cards Section */}
        <Text variant="h2" className="mb-4">Cards</Text>
        <Card className="mb-8">
          <CardHeader>
            <CardTitle>
            ...
            <CardDescription>
              <Text>Card description goes here. This is a sample card component.</Text>
            </CardDescription>
          </CardHeader>
          <CardContent>
        ...
        {/* Form Elements */}
        <Text variant="h2" className="mb-4">Form Elements</Text>
        ...
        {/* Badges */}
        <Text variant="h2" className="mb-4">Badges</Text>
        <View className="flex-row flex-wrap gap-2 mb-8">
          <Badge>
            <Text>Default</Text>
          </Badge>
        ...
        <Text variant="h2" className="mb-4">Dialogs & Sheets</Text>
        <View className="gap-3 mb-8">
          ...
          <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
            ...
            <DialogContent>
              <DialogHeader>
                ...
                <DialogDescription>
                  <Text variant="muted">Are you sure you want to proceed? This action cannot be undone.</Text>
                </DialogDescription>
              </DialogHeader>
              <DialogFooter>
          ...
          <Sheet open={sheetOpen} onOpenChange={setSheetOpen}>
            ...
            <SheetContent snapPoints={["25%", "50%", "90%"]}>
              <SheetHeader>
                ...
                <SheetDescription>
                  <Text variant="muted">Swipe down to dismiss or tap the X button</Text>
                </SheetDescription>
              </SheetHeader>
              <View className="mt-4">
                <Text>This is a bottom sheet that can be dragged.</Text>
                <Text className="mt-2">It supports multiple snap points.</Text>
              </View>
            </SheetContent>
          </Sheet>
          ...
          <Drawer open={drawerOpen} onOpenChange={setDrawerOpen}>
            ...
            <DrawerContent>
              ...
              <DrawerItem icon={<HomeIcon className="h-5 w-5 text-foreground" />}>
                <Text>Home</Text>
              </DrawerItem>
              <DrawerItem icon={<UserIcon className="h-5 w-5 text-foreground" />}>
                <Text>Profile</Text>
              </DrawerItem>
              <DrawerSeparator />
              <DrawerItem icon={<SettingsIcon className="h-5 w-5 text-foreground" />}>
                <Text>Settings</Text>
              </DrawerItem>
            </DrawerContent>
          </Drawer>
        ...
        {/* DataTable Example */}
        <Text variant="h2" className="mb-4">Data Table</Text>
        <Card className="mb-8">
          <CardHeader>
            <CardTitle>
            ...
            <CardDescription>
              <Text>MUI DataGrid-style table with sorting, pagination & selection</Text>
            </CardDescription>
          </CardHeader>
          <CardContent>
            <DataTable
              rows={[
                ...
                { id: 8, name: "Fiona Apple", email: "fiona@example.com", role: "Moderator", status: "Active" },
              ]}
              columns={[
              ...
              selectable
              variant="striped"
              onRowClick={(row) => Alert.alert("Row Clicked", `Selected: ${row.name}`)}
            />
...
/>`;
            ...
            >
              <Text variant="code" className="text-xs">Tap to copy DataTable example</Text>
            </Pressable>
          </CardContent>
        </Card>

        {/* Permission Examples */}
        <Text variant="h2" className="mb-4">Permissions</Text>
        <Card className="mb-4">
          <CardContent className="pt-3">
...
const { status } = await Location.requestForegroundPermissionsAsync();`;
            ...
            >
              <Text variant="code" className="text-xs">Tap for permission hook examples</Text>
            </Pressable>
          </CardContent>
        </Card>
        <View className="gap-3 mb-8">
          ...
          <PermissionRequester
            ...
            onPermissionGranted={() => {/* Handle location permission granted */}}
            onPermissionDenied={() => {/* Handle location permission denied */}}
          >
            {({ status, requestPermission }) => (
              ...
              >
                <Text>
                  {status === "granted" ? "✓ Location Access Granted" : "Request Location Access"}
                </Text>
              </Button>
            )}
          </PermissionRequester>
          ...
          <PermissionRequester
            ...
            onPermissionGranted={() => {/* Handle notifications permission granted */}}
          >
            {({ status, requestPermission }) => (
              <Button
          ...
          <Card>
            <CardContent className="pt-6">
              <Text variant="small" className="mb-2">Permission Hook Example:</Text>
...
// Use camera...`}
        ...
        {/* Hamburger Menu Demo */}
        <Text variant="h2" className="mb-4">Hamburger Menu</Text>
        <Card className="mb-8">
          <CardContent className="pt-6">
  ...
  {/* Your screen content */}
        ...
        {/* Safe Area Demo */}
        <Text variant="h2" className="mb-4">Layout Info</Text>
        <Card className="mb-8">
          <CardContent className="pt-6">
            <Text variant="small" className="mb-2">Pull down to refresh</Text>
